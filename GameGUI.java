...
public class GameGUI extends JComponent {
		...
		ActionListener animator = new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				if (!gameModel.isGameOver()) {
					System.out.println(getBoardStr(gameModel));
	...
	public static void main(String[] args) {
		Runnable createShowGUI = new Runnable() {
			public void run() {
				int maxRows = Integer.parseInt(JOptionPane.showInputDialog(null, "Enter number of rows", 25));
				int maxCols = Integer.parseInt(JOptionPane.showInputDialog(null, "Enter number of columns", 70));
				int timerDelayInMilliSecs = Integer
						.parseInt(JOptionPane.showInputDialog(null, "Enter speed in milliseconds", 900));
	...
	private String getBoardStr(Game game) {
